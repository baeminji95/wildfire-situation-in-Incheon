    ...
    return (
        <article className="relative flex flex-col w-full h-full">
            ...
            <div className="w-full max-w-[500px] mx-auto h-full inline-grid grid-cols-5 grid-rows-24-1fr-1fr p-4 gap-5">
                ...
                <div className="h-[10rem] bg-guide3_2 col-span-3 bg-cover bg-center relative z-10">
                    {/* 설명 말풍선 */}
                    <p className="absolute w-full top-[110%] left-0 text-[#0079C1] px-2 py-1 z-30 bg-white flex justify-center items-center text-[0.9rem] tooltip1">
                        지도를 통해 선택하신 구/군의 지역을 범위를 한눈에 확인 하실 수 있습니다.
                    </p>
                </div>
